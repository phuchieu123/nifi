...
@CapabilityDescription("Cung cấp Dịch vụ Pooling Kết nối Cơ sở dữ liệu cho Apache Hive 1.1.x. Các kết nối có thể được lấy từ pool và trả về sau khi sử dụng.")
